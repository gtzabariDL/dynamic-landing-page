...
const GoogleTagScript = () => (
  <Helmet>
    <script async defer src="https://www.googletagmanager.com/gtm.js?id=GTM-KLSVFF2"></script>
    <script defer>
      {`
...
const startSessionRecording = () => {
  ...
  // Defer PostHog initialization to avoid blocking render
...
export const AppScriptsLauncher = ({ children }: PropsWithChildren<unknown>) => {
  return (
    <HelmetProvider>
      ...
      >
        <script src="posthog.js" async defer></script>
      </EventHelmet>
      <GoogleTagScript />
      {children}
    </HelmetProvider>
