...
const faqItems = [
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="mb-4">
          If you need more help, we have training and support for you and your entire team. We also include tutorial videos, articles, and more.
        </p>
        <p>
    ...
    answer: (
      <>
        ...
        <ol className="list-decimal pl-6 mb-4">
          <li className="mb-2">
            <span className="font-semibold">Ease of use:</span> Take our complex competitor test. Get a free demo from our top three competitors, and see for yourself which is the easiest.
          </li>
          <li className="mb-2">
            <span className="font-semibold">Comprehensiveness:</span> We built the most important features you need to successfully manage your properties.
          </li>
          <li className="mb-2">
            <span className="font-semibold">World-class support:</span> Our average response time to any messages, emails, or chats is 5 minutes!
          </li>
        </ol>
        <p>
          Sign up today and see why everyone is switching to DoorLoop. We&apos;ll even import your current leases for free.
        </p>
      </>
    )
  },
  ...
  },
  {
    ...
    answer: (
      <>
        <p className="mb-4">
          Why juggle multiple programs when one can do it all? With DoorLoop&apos;s all-in-one software, skip toggling between numerous platforms. Use our prefilled templates, automated reminders, and integrated tracking instead of manual document handling.
        </p>
        <p>
          Automate your repetitive tasks so you can focus on what really matters: building better relationships and efficiently growing your business.
        </p>
      </>
    )
  },
  {
    ...
    answer: (
      <>
        <p className="mb-4">After years of trial and error, we came up with the Perfect Portfolio Plan:</p>
        <ol className="list-decimal pl-6 mb-4">
          <li className="mb-2">Step 1: <a href="#" className="text-blue-600 hover:text-blue-800">Schedule a demo</a>.</li>
          <li className="mb-2">Step 2: If you&apos;re using another software, migrate your data with our team&apos;s assistance.</li>
          <li className="mb-2">Step 3: Complete a one-hour basic training.</li>
          <li className="mb-2">Step 4: Input properties, tenants, and leases; email your tenants a link to their new tenant portal; and activate the owner portal for your investors.</li>
        </ol>
        <p>
          It really is that simple. <a href="#" className="text-blue-600 hover:text-blue-800">Click here</a> to schedule your demo and get started.
        </p>
      </>
    )
  }
...
const pricingFaqItems = [
  {
    ...
    answer: (
      <>
        <p className="mb-4">
          Prices start at only $69/month for your first 20 units.
        </p>
        <p>
          You will receive free updates, data migration, training and support.
        </p>
      </>
    )
  },
  {
    ...
    answer: (
      <>
        ...
        <p>
          You can schedule your free demo today and see how the software works with a dedicated account manager to answer as many questions as you like.
        </p>
      </>
    )
  },
  ...
  },
  {
    ...
    answer: (
      <>
        <p>
          No. We believe you should have the freedom to use any software you like without being tied down by corporate contracts. With DoorLoop, you are free to cancel your account at any time or export your data and use another software.
        </p>
      </>
    )
  },
  {
    ...
    answer: (
      <>
        ...
        <p className="mb-4">
          <strong>Tenant Screening (by TransUnion)</strong>: The cost to your prospective tenants is only $45 on the Starter plan, $35 on the Pro, and $25 on the Premium. It includes a US national criminal background check, eviction history, and credit report. You can also markup the cost and keep any profits.
        </p>
        <p className="mb-4">
          <strong>Credit Card and ACH Payments (by Stripe)</strong>: Automate your rent collection with a one-time setup fee of $49 per bank account on the Starter plan, $25 on the Pro, and free on the Premium.
        </p>
        <p className="mb-4">
          Your tenants pay a 3.25% service fee for credit card payments or $2.49 for ACH ($1 on the Pro plan and free on the Premium plan). Tenants see their convenience fees upfront for transparency.
        </p>
        <p className="mb-4">Other benefits include:</p>
        <ol className="list-decimal pl-6">
          <li className="mb-2">
            <strong>Outgoing EFT payments</strong>: $1 each under the Pro and Premium plans. You can also mail checks for $1.50.
          </li>
          <li>
            <strong>eSignatures</strong>: $1 per document regardless of how many people need to sign.
          </li>
        </ol>
      </>
    )
...
const dataFaqItems = [
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <p>
          DoorLoop is hosted by Amazon Web Services (AWS), the leader in data security.
        </p>
      </>
    )
  },
  {
    ...
    answer: (
      <>
        <p className="mb-4">
          With user access roles, you can allow or block access to certain parts of the software from any user.
        </p>
        <p>
          For example, you could allow someone to add new tenants but not delete tenants. Or, you could completely block access to all financials, accounting and reports.
        </p>
      </>
    )
  },
...
export default function FAQSection() {
  ...
  const currentFaqItems = activeTab === 'Pricing'
    ? pricingFaqItems
    : activeTab === 'Data'
      ? dataFaqItems
      : faqItems;
