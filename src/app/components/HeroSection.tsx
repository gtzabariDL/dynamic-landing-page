...
export default function HeroSection() {
  ...
  return (
    <section className="relative flex-grow flex-col flex items-center justify-center px-4 py-8 w-full h-[98vh]">
      <div className="fixed top-0 left-0 w-full h-[98vh] bg-[url('/hero-background.svg')] bg-no-repeat bg-cover -z-10 hidden md:block" />
